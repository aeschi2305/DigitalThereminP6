...
$(MEM_0)_HIERARCHICAL_PATH := dram_cntrl
$(MEM_0)_WIDTH := 16
...
.PHONY: dram_cntrl
dram_cntrl: check_elf_exists $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: epcs_cntl
MEM_1 := epcs_cntl
$(MEM_1)_NAME := epcs_cntl
HEX_FILES += $(MEM_INIT_DIR)/$(MEM_1).hex
MEM_INIT_INSTALL_FILES += $(MEM_INIT_INSTALL_DIR)/$(MEM_1).hex
$(MEM_1)_START := 0x09000000
$(MEM_1)_END := 0x09ffffff
$(MEM_1)_SPAN := 0x01000000
$(MEM_1)_HIERARCHICAL_PATH := epcs_cntl
$(MEM_1)_WIDTH := 32
...
.PHONY: epcs_cntl
epcs_cntl: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex
