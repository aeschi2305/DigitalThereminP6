//altasmi_parallel CBX_AUTO_BLACKBOX="ALL" CBX_SINGLE_OUTPUT_FILE="ON" DATA_WIDTH="STANDARD" DEVICE_FAMILY="Cyclone V" ENABLE_SIM="TRUE" EPCS_TYPE="EPCS128" FLASH_RSTPIN="FALSE" PAGE_SIZE=256 PORT_BULK_ERASE="PORT_USED" PORT_DIE_ERASE="PORT_UNUSED" PORT_EN4B_ADDR="PORT_UNUSED" PORT_EX4B_ADDR="PORT_UNUSED" PORT_FAST_READ="PORT_USED" PORT_ILLEGAL_ERASE="PORT_USED" PORT_ILLEGAL_WRITE="PORT_USED" PORT_RDID_OUT="PORT_USED" PORT_READ_ADDRESS="PORT_UNUSED" PORT_READ_DUMMYCLK="PORT_USED" PORT_READ_RDID="PORT_USED" PORT_READ_SID="PORT_UNUSED" PORT_READ_STATUS="PORT_USED" PORT_SECTOR_ERASE="PORT_USED" PORT_SECTOR_PROTECT="PORT_USED" PORT_SHIFT_BYTES="PORT_USED" PORT_WREN="PORT_USED" PORT_WRITE="PORT_USED" USE_ASMIBLOCK="ON" USE_EAB="ON" WRITE_DUMMY_CLK=0 addr bulk_erase busy clkin data_valid datain dataout fast_read illegal_erase illegal_write rden rdid_out read_dummyclk read_rdid read_status reset sector_erase sector_protect shift_bytes status_out wren write INTENDED_DEVICE_FAMILY=""" ALTERA_INTERNAL_OPTIONS=SUPPRESS_DA_RULE_INTERNAL=C106
//VERSION_BEGIN 17.1 cbx_a_gray2bin 2017:10:25:18:06:52:SJ cbx_a_graycounter 2017:10:25:18:06:52:SJ cbx_altasmi_parallel 2017:10:25:18:06:52:SJ cbx_altdpram 2017:10:25:18:06:52:SJ cbx_altera_counter 2017:10:25:18:06:52:SJ cbx_altera_syncram 2017:10:25:18:06:52:SJ cbx_altera_syncram_nd_impl 2017:10:25:18:06:52:SJ cbx_altsyncram 2017:10:25:18:06:53:SJ cbx_arriav 2017:10:25:18:06:52:SJ cbx_cyclone 2017:10:25:18:06:53:SJ cbx_cycloneii 2017:10:25:18:06:53:SJ cbx_fifo_common 2017:10:25:18:06:52:SJ cbx_lpm_add_sub 2017:10:25:18:06:53:SJ cbx_lpm_compare 2017:10:25:18:06:53:SJ cbx_lpm_counter 2017:10:25:18:06:53:SJ cbx_lpm_decode 2017:10:25:18:06:53:SJ cbx_lpm_mux 2017:10:25:18:06:53:SJ cbx_mgl 2017:10:25:18:08:29:SJ cbx_nadder 2017:10:25:18:06:53:SJ cbx_nightfury 2017:10:25:18:06:52:SJ cbx_scfifo 2017:10:25:18:06:53:SJ cbx_stratix 2017:10:25:18:06:53:SJ cbx_stratixii 2017:10:25:18:06:53:SJ cbx_stratixiii 2017:10:25:18:06:53:SJ cbx_stratixv 2017:10:25:18:06:53:SJ cbx_util_mgl 2017:10:25:18:06:53:SJ cbx_zippleback 2017:10:25:18:06:52:SJ  VERSION_END
...
//synthesis_resources = a_graycounter 6 cyclonev_asmiblock 1 lpm_compare 2 lpm_counter 2 lut 29 mux21 2 reg 143 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"SUPPRESS_DA_RULE_INTERNAL=C106"} *)
module  digital_theremin_epcs_cntl_altera_asmi_parallel_digital_theremin_epcs_cntl_altera_asmi_parallel_digital_theremin_epcs_cntl
	( 
	addr,
	bulk_erase,
	busy,
...
`endif
	...
	cyclonev_asmiblock   sd3
	( 
	.data0in(),
	.data0oe(dataoe_wire[0]),
	.data0out(sdoin_wire),
	.data1in(wire_sd3_data1in),
	...
	defparam
		sd3.enable_sim = "true",
		sd3.lpm_type = "cyclonev_asmiblock";
	// synopsys translate_off
	initial
		add_msb_reg = 0;
	// synopsys translate_on
	...
	assign
		...
		data0out_wire = wire_sd3_data1in,
		...
		mask_prot_add = {(mask_prot[5] & addr_reg[23]), (mask_prot[4] & addr_reg[22]), (mask_prot[3] & addr_reg[21]), (mask_prot[2] & addr_reg[20]), (mask_prot[1] & addr_reg[19]), (mask_prot[0] & addr_reg[18])},
...
endmodule //digital_theremin_epcs_cntl_altera_asmi_parallel_digital_theremin_epcs_cntl_altera_asmi_parallel_digital_theremin_epcs_cntl
//VALID FILE
