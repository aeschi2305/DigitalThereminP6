...
void codec_wm8731_init(void)
{
	...
	alt_up_av_config_write_audio_cfg_register(i2c_dev,0x02,0x15B); //Left Headphone Out mute Enable Simultaneous Load of LHPVOL[6:0] and LZCEN to RHPVOL[6:0] and RZCEN, zero crossing
	alt_up_av_config_write_audio_cfg_register(i2c_dev,0x03,0x15B); //Right Headphone Out mute Enable Simultaneous Load of LHPVOL[6:0] and LZCEN to RHPVOL[6:0] and RZCEN, zero crossing
