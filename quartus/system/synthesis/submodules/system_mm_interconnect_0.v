...
module system_mm_interconnect_0 (
		...
		input  wire        volume_generation_top_0_reset_reset_bridge_in_reset_reset,   //  volume_generation_top_0_reset_reset_bridge_in_reset.reset
	...
	wire   [13:0] cmd_mux_010_src_channel;                                                          // cmd_mux_010:src_channel -> Pitch_dummy_0_sp_agent:cp_channel
	...
	wire   [13:0] cmd_mux_011_src_channel;                                                          // cmd_mux_011:src_channel -> Volume_dummy_0_sp_agent:cp_channel
	...
	wire   [13:0] cmd_mux_012_src_channel;                                                          // cmd_mux_012:src_channel -> touch_panel_spi_spi_control_port_agent:cp_channel
	...
	wire   [13:0] cmd_demux_src12_channel;                                                          // cmd_demux:src12_channel -> crosser_005:in_channel
	...
	wire   [13:0] crosser_005_out_channel;                                                          // crosser_005:out_channel -> cmd_mux_012:sink0_channel
	...
	wire   [13:0] cmd_demux_src13_channel;                                                          // cmd_demux:src13_channel -> crosser_006:in_channel
	...
	wire   [13:0] crosser_006_out_channel;                                                          // crosser_006:out_channel -> cmd_mux_013:sink0_channel
	...
	wire  [105:0] rsp_demux_src0_data;                                                              // rsp_demux:src0_data -> crosser_007:in_data
	wire          rsp_demux_src0_ready;                                                             // crosser_007:in_ready -> rsp_demux:src0_ready
	wire   [13:0] rsp_demux_src0_channel;                                                           // rsp_demux:src0_channel -> crosser_007:in_channel
	...
	wire  [105:0] crosser_007_out_data;                                                             // crosser_007:out_data -> rsp_mux:sink0_data
	wire          crosser_007_out_ready;                                                            // rsp_mux:sink0_ready -> crosser_007:out_ready
	wire   [13:0] crosser_007_out_channel;                                                          // crosser_007:out_channel -> rsp_mux:sink0_channel
	...
	wire  [105:0] rsp_demux_002_src0_data;                                                          // rsp_demux_002:src0_data -> crosser_008:in_data
	...
	wire  [105:0] crosser_008_out_data;                                                             // crosser_008:out_data -> rsp_mux:sink2_data
	...
	wire  [105:0] rsp_demux_006_src0_data;                                                          // rsp_demux_006:src0_data -> crosser_009:in_data
	wire          rsp_demux_006_src0_ready;                                                         // crosser_009:in_ready -> rsp_demux_006:src0_ready
	wire   [13:0] rsp_demux_006_src0_channel;                                                       // rsp_demux_006:src0_channel -> crosser_009:in_channel
	...
	wire  [105:0] crosser_009_out_data;                                                             // crosser_009:out_data -> rsp_mux:sink6_data
	wire          crosser_009_out_ready;                                                            // rsp_mux:sink6_ready -> crosser_009:out_ready
	wire   [13:0] crosser_009_out_channel;                                                          // crosser_009:out_channel -> rsp_mux:sink6_channel
	...
	wire  [105:0] rsp_demux_007_src0_data;                                                          // rsp_demux_007:src0_data -> crosser_010:in_data
	wire          rsp_demux_007_src0_ready;                                                         // crosser_010:in_ready -> rsp_demux_007:src0_ready
	wire   [13:0] rsp_demux_007_src0_channel;                                                       // rsp_demux_007:src0_channel -> crosser_010:in_channel
	...
	wire  [105:0] crosser_010_out_data;                                                             // crosser_010:out_data -> rsp_mux:sink7_data
	wire          crosser_010_out_ready;                                                            // rsp_mux:sink7_ready -> crosser_010:out_ready
	wire   [13:0] crosser_010_out_channel;                                                          // crosser_010:out_channel -> rsp_mux:sink7_channel
	...
	wire  [105:0] rsp_demux_008_src0_data;                                                          // rsp_demux_008:src0_data -> crosser_011:in_data
	wire          rsp_demux_008_src0_ready;                                                         // crosser_011:in_ready -> rsp_demux_008:src0_ready
	wire   [13:0] rsp_demux_008_src0_channel;                                                       // rsp_demux_008:src0_channel -> crosser_011:in_channel
	...
	wire  [105:0] crosser_011_out_data;                                                             // crosser_011:out_data -> rsp_mux:sink8_data
	wire          crosser_011_out_ready;                                                            // rsp_mux:sink8_ready -> crosser_011:out_ready
	wire   [13:0] crosser_011_out_channel;                                                          // crosser_011:out_channel -> rsp_mux:sink8_channel
	...
	wire  [105:0] rsp_demux_012_src0_data;                                                          // rsp_demux_012:src0_data -> crosser_012:in_data
	wire          rsp_demux_012_src0_ready;                                                         // crosser_012:in_ready -> rsp_demux_012:src0_ready
	wire   [13:0] rsp_demux_012_src0_channel;                                                       // rsp_demux_012:src0_channel -> crosser_012:in_channel
	...
	wire          crosser_012_out_valid;                                                            // crosser_012:out_valid -> rsp_mux:sink12_valid
	wire  [105:0] crosser_012_out_data;                                                             // crosser_012:out_data -> rsp_mux:sink12_data
	wire          crosser_012_out_ready;                                                            // rsp_mux:sink12_ready -> crosser_012:out_ready
	wire   [13:0] crosser_012_out_channel;                                                          // crosser_012:out_channel -> rsp_mux:sink12_channel
	wire          crosser_012_out_startofpacket;                                                    // crosser_012:out_startofpacket -> rsp_mux:sink12_startofpacket
	wire          crosser_012_out_endofpacket;                                                      // crosser_012:out_endofpacket -> rsp_mux:sink12_endofpacket
	wire          rsp_demux_013_src0_valid;                                                         // rsp_demux_013:src0_valid -> crosser_013:in_valid
	wire  [105:0] rsp_demux_013_src0_data;                                                          // rsp_demux_013:src0_data -> crosser_013:in_data
	wire          rsp_demux_013_src0_ready;                                                         // crosser_013:in_ready -> rsp_demux_013:src0_ready
	wire   [13:0] rsp_demux_013_src0_channel;                                                       // rsp_demux_013:src0_channel -> crosser_013:in_channel
	wire          rsp_demux_013_src0_startofpacket;                                                 // rsp_demux_013:src0_startofpacket -> crosser_013:in_startofpacket
	wire          rsp_demux_013_src0_endofpacket;                                                   // rsp_demux_013:src0_endofpacket -> crosser_013:in_endofpacket
	wire          crosser_013_out_valid;                                                            // crosser_013:out_valid -> rsp_mux:sink13_valid
	wire  [105:0] crosser_013_out_data;                                                             // crosser_013:out_data -> rsp_mux:sink13_data
	wire          crosser_013_out_ready;                                                            // rsp_mux:sink13_ready -> crosser_013:out_ready
	wire   [13:0] crosser_013_out_channel;                                                          // crosser_013:out_channel -> rsp_mux:sink13_channel
	wire          crosser_013_out_startofpacket;                                                    // crosser_013:out_startofpacket -> rsp_mux:sink13_startofpacket
	wire          crosser_013_out_endofpacket;                                                      // crosser_013:out_endofpacket -> rsp_mux:sink13_endofpacket
	...
	altera_merlin_slave_translator #(
		...
		.reset                  (volume_generation_top_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (pll_0_outclk0_clk),                                            //             clk.clk
		.reset                   (volume_generation_top_0_reset_reset_bridge_in_reset_reset),    //       clk_reset.reset
	...
	system_mm_interconnect_0_rsp_mux rsp_mux (
		...
		.sink12_ready         (crosser_012_out_ready),                 //    sink12.ready
		.sink12_valid         (crosser_012_out_valid),                 //          .valid
		.sink12_channel       (crosser_012_out_channel),               //          .channel
		.sink12_data          (crosser_012_out_data),                  //          .data
		.sink12_startofpacket (crosser_012_out_startofpacket),         //          .startofpacket
		.sink12_endofpacket   (crosser_012_out_endofpacket),           //          .endofpacket
		.sink13_ready         (crosser_013_out_ready),                 //    sink13.ready
		.sink13_valid         (crosser_013_out_valid),                 //          .valid
		.sink13_channel       (crosser_013_out_channel),               //          .channel
		.sink13_data          (crosser_013_out_data),                  //          .data
		.sink13_startofpacket (crosser_013_out_startofpacket),         //          .startofpacket
		.sink13_endofpacket   (crosser_013_out_endofpacket)            //          .endofpacket
	);
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (volume_generation_top_0_reset_reset_bridge_in_reset_reset), // out_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (volume_generation_top_0_reset_reset_bridge_in_reset_reset), //  in_clk_reset.reset
		.out_clk           (pll_outclk0_clk),                                           //       out_clk.clk
		.out_reset         (cpu_reset_reset_bridge_in_reset_reset),                     // out_clk_reset.reset
	...
	system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (volume_generation_top_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
