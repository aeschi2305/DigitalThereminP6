...
module system_mm_interconnect_0 (
	...
	wire   [10:0] cmd_mux_src_channel;                                                              // cmd_mux:src_channel -> audio_and_video_config_0_avalon_av_config_slave_agent:cp_channel
	...
	wire   [10:0] cmd_mux_001_src_channel;                                                          // cmd_mux_001:src_channel -> jtag_uart_avalon_jtag_slave_agent:cp_channel
	...
	wire   [10:0] cmd_mux_002_src_channel;                                                          // cmd_mux_002:src_channel -> LCD_Controller_avalon_slave_0_agent:cp_channel
	...
	wire   [10:0] cmd_mux_003_src_channel;                                                          // cmd_mux_003:src_channel -> sysid_control_slave_agent:cp_channel
	...
	wire   [10:0] cmd_mux_004_src_channel;                                                          // cmd_mux_004:src_channel -> cpu_debug_mem_slave_agent:cp_channel
	...
	wire   [10:0] cmd_mux_006_src_channel;                                                          // cmd_mux_006:src_channel -> LCD_Reset_N_s1_agent:cp_channel
	...
	wire   [10:0] cmd_mux_009_src_channel;                                                          // cmd_mux_009:src_channel -> timer_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_010_src_data;                                                             // cmd_mux_010:src_data -> touch_panel_spi_spi_control_port_agent:cp_data
	...
	wire  [105:0] touch_panel_spi_spi_control_port_agent_rp_data;                                   // touch_panel_spi_spi_control_port_agent:rp_data -> router_012:sink_data
	...
	wire   [10:0] dram_ctrl_s1_burst_adapter_source0_channel;                                       // dram_ctrl_s1_burst_adapter:source0_channel -> dram_ctrl_s1_agent:cp_channel
	...
	wire   [10:0] router_007_src_channel;                                                           // router_007:src_channel -> dram_ctrl_s1_rsp_width_adapter:in_channel
	...
	wire   [10:0] dram_ctrl_s1_rsp_width_adapter_src_channel;                                       // dram_ctrl_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	...
	wire   [10:0] cmd_mux_005_src_channel;                                                          // cmd_mux_005:src_channel -> dram_ctrl_s1_cmd_width_adapter:in_channel
	...
	wire   [10:0] dram_ctrl_s1_cmd_width_adapter_src_channel;                                       // dram_ctrl_s1_cmd_width_adapter:out_channel -> dram_ctrl_s1_burst_adapter:sink0_channel
	...
	wire  [105:0] cmd_demux_src10_data;                                                             // cmd_demux:src10_data -> crosser_005:in_data
	wire          cmd_demux_src10_ready;                                                            // crosser_005:in_ready -> cmd_demux:src10_ready
	wire   [10:0] cmd_demux_src10_channel;                                                          // cmd_demux:src10_channel -> crosser_005:in_channel
	...
	wire  [105:0] crosser_005_out_data;                                                             // crosser_005:out_data -> cmd_mux_010:sink0_data
	wire          crosser_005_out_ready;                                                            // cmd_mux_010:sink0_ready -> crosser_005:out_ready
	wire   [10:0] crosser_005_out_channel;                                                          // crosser_005:out_channel -> cmd_mux_010:sink0_channel
	...
	wire   [10:0] rsp_demux_src0_channel;                                                           // rsp_demux:src0_channel -> crosser_006:in_channel
	...
	wire   [10:0] crosser_006_out_channel;                                                          // crosser_006:out_channel -> rsp_mux:sink0_channel
	...
	wire   [10:0] rsp_demux_002_src0_channel;                                                       // rsp_demux_002:src0_channel -> crosser_007:in_channel
	...
	wire   [10:0] rsp_demux_006_src0_channel;                                                       // rsp_demux_006:src0_channel -> crosser_008:in_channel
	...
	wire   [10:0] crosser_008_out_channel;                                                          // crosser_008:out_channel -> rsp_mux:sink6_channel
	...
	wire   [10:0] rsp_demux_007_src0_channel;                                                       // rsp_demux_007:src0_channel -> crosser_009:in_channel
	...
	wire   [10:0] crosser_009_out_channel;                                                          // crosser_009:out_channel -> rsp_mux:sink7_channel
	...
	wire   [10:0] rsp_demux_008_src0_channel;                                                       // rsp_demux_008:src0_channel -> crosser_010:in_channel
	...
	wire   [10:0] crosser_010_out_channel;                                                          // crosser_010:out_channel -> rsp_mux:sink8_channel
	...
	wire  [105:0] rsp_demux_010_src0_data;                                                          // rsp_demux_010:src0_data -> crosser_011:in_data
	wire          rsp_demux_010_src0_ready;                                                         // crosser_011:in_ready -> rsp_demux_010:src0_ready
	wire   [10:0] rsp_demux_010_src0_channel;                                                       // rsp_demux_010:src0_channel -> crosser_011:in_channel
	...
	wire  [105:0] crosser_011_out_data;                                                             // crosser_011:out_data -> rsp_mux:sink10_data
	wire          crosser_011_out_ready;                                                            // rsp_mux:sink10_ready -> crosser_011:out_ready
	wire   [10:0] crosser_011_out_channel;                                                          // crosser_011:out_channel -> rsp_mux:sink10_channel
	...
	wire          touch_panel_spi_spi_control_port_agent_rdata_fifo_out_valid;                      // touch_panel_spi_spi_control_port_agent_rdata_fifo:out_valid -> avalon_st_adapter_010:in_0_valid
	wire   [33:0] touch_panel_spi_spi_control_port_agent_rdata_fifo_out_data;                       // touch_panel_spi_spi_control_port_agent_rdata_fifo:out_data -> avalon_st_adapter_010:in_0_data
	wire          touch_panel_spi_spi_control_port_agent_rdata_fifo_out_ready;                      // avalon_st_adapter_010:in_0_ready -> touch_panel_spi_spi_control_port_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_010_out_0_valid;                                                // avalon_st_adapter_010:out_0_valid -> touch_panel_spi_spi_control_port_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_010_out_0_data;                                                 // avalon_st_adapter_010:out_0_data -> touch_panel_spi_spi_control_port_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_010_out_0_ready;                                                // touch_panel_spi_spi_control_port_agent:rdata_fifo_sink_ready -> avalon_st_adapter_010:out_0_ready
	wire    [0:0] avalon_st_adapter_010_out_0_error;                                                // avalon_st_adapter_010:out_0_error -> touch_panel_spi_spi_control_port_agent:rdata_fifo_sink_error
	...
	system_mm_interconnect_0_rsp_demux_002 rsp_demux_010 (
		.clk                (pll_outclk1_clk),                                  //       clk.clk
		.reset              (LCD_Controller_reset_reset_bridge_in_reset_reset), // clk_reset.reset
