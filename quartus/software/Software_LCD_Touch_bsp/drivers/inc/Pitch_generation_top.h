 ...
 * Content : 
 *--------------------------------------------------*/
#ifndef __PITCH_GENERATION_TOP_H__
#define __PITCH_GENERATION_TOP_H__
 ...
 */
#define PITCH_GENERATION_TOP_INSTANCE(name, device) extern int alt_no_storage
#define PITCH_GENERATION_TOP_INIT(name, device) while (0)
