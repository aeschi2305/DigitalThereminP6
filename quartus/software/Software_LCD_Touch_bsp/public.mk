...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80010b8
SOPC_SYSID_FLAG += --sidp=0x80010b8
ELF_PATCH_FLAG  += --sidp 0x80010b8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1596114605
SOPC_SYSID_FLAG += --timestamp=1596114605
ELF_PATCH_FLAG  += --timestamp 1596114605
