...
add_fileset_file cordic_control.vhd VHDL PATH IP/Tone_generation/cordic/cordic_control.vhd
add_fileset_file cordic_pipelined.vhd VHDL PATH IP/Tone_generation/cordic/cordic_pipelined.vhd
add_fileset_file FIR_Decimation.vhd VHDL PATH IP/Tone_generation/filter/FIR_Decimation.vhd
add_fileset_file Filter.vhd VHDL PATH IP/Tone_generation/filter/Filter.vhd
add_fileset_file cic.vhd VHDL PATH IP/Tone_generation/filter/cic.vhd
add_fileset_file filter_streaming.vhd VHDL PATH IP/Tone_generation/filter/filter_streaming.vhd
add_fileset_file FIR.vhd VHDL PATH IP/Tone_generation/freq_mes/FIR.vhd
add_fileset_file count_freq_meas.vhd VHDL PATH IP/Tone_generation/freq_mes/count_freq_meas.vhd
add_fileset_file freq_meas.vhd VHDL PATH IP/Tone_generation/freq_mes/freq_meas.vhd
add_fileset_file goldschmidt.vhd VHDL PATH IP/Tone_generation/freq_mes/goldschmidt.vhd
add_fileset_file mixer.vhd VHDL PATH IP/Tone_generation/mixer/mixer.vhd


# 
# parameters
# 
add_parameter dat_len_avl NATURAL 24
set_parameter_property dat_len_avl DEFAULT_VALUE 24
...
add_parameter cic1Bits NATURAL 23
set_parameter_property cic1Bits DEFAULT_VALUE 23
...
add_parameter cic2Bits NATURAL 26
set_parameter_property cic2Bits DEFAULT_VALUE 26
...
add_parameter cic3Bits NATURAL 29
set_parameter_property cic3Bits DEFAULT_VALUE 29
...
add_interface_port conduit_end coe_square_freq export Bidir 1
